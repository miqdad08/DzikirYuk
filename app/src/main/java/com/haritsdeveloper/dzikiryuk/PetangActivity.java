...
public class PetangActivity extends AppCompatActivity {
    ...
    RecyclerView rvmaindua;
    ArrayList<ModelDzikir> arrayList;
    //int count = 0;
    String idDzikirPetang;

    private String[] menuItemPetang = {"أَعُوذُ بِاللَّهِ مِنَ الشَّيْطَانِ الرَّجِيم",
    ...
    private String[] menuSubItemPetang = {"“Aku berlindung kepada Allah dari godaan syaitan yang terkutuk.”",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rvmaindua = findViewById(R.id.rvMaindua);
        arrayList = new ArrayList<>();
        setdatapagi();

        rvmaindua.setLayoutManager(new LinearLayoutManager(this));
        rvmaindua.setHasFixedSize(true);
        adapterDzikir = new AdapterDzikir(arrayList);
        rvmaindua.setAdapter(adapterDzikir);
    }

    private void setdatapagi() {
        int count = 0;
        for (String id:menuItemPetang){
            arrayList.add(new ModelDzikir(id, menuSubItemPetang[count]));
            count++;
    }
}
}
